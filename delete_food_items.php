      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#" style="color: white;"><span class=""></span> Welcome <?php echo $login_session; ?> </a></li>
            <li class="active"> <a href="managerlogin.php" style="background-color: white;color: #84654e;">MANAGER CONTROL PANEL</a></li>
            <li><a href="logout_m.php" style="color: white;"><span class=""></span> Log Out </a></li>
          </ul>
        </div>
