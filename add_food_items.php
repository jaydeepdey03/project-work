...
<div class="container">
    <div class="container">
      ...
      <a href="myrestaurant.php" class="list-group-item ">My Restaurant</a>
    		...
    		<a href="add_food_items.php" class="list-group-item active" style="background-color: #84654e;">Add Food Items</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right" style="background-color: #84654e;"> ADD FOOD </button>    
      </div>
        </form>
