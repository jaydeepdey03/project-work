      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#" style="color: #fff;"><span class=""></span> Sign Up </a></li>
            <li><a href="#" style="color: #fff;"><span class=""></span> Login </a></li>
          </ul>
        </div>
...
<div class="container">
<div class="jumbotron" style="text-align: center; background: url('https://cdn.hipwallpaper.com/i/97/53/QW3VYy.jpg') no-repeat; color: #754826;">
		<h2> <?php echo "Welcome $fullname!" ?> </h2>
		<h1>Your account has been created.</h1>
		<p>Login Now from <a href="customerlogin.php" style="color: #84654e; text-decoration: underline;">HERE</a></p>
	</div>
</div>
