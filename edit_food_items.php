...
<html>
  ...
  <head>
    <title> Manager Login | The Yellow Tree Cafe </title>
  </head>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#" style="color: #fff;"><span class=""></span> Welcome <?php echo $login_session; ?> </a></li>
            <li class="active"> <a href="managerlogin.php" style="color: #fff;">MANAGER CONTROL PANEL</a></li>
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="edit_food_items.php" class="list-group-item active" style="background-color: #84654e;">Edit Food Items</a>
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    while ($row = mysqli_fetch_array($query)) {
      ...
      <div class="list-group" style="text-align: center; color: #84654e">
        <?php
      echo "<b><a style='color: #84654e;' href='edit_food_items.php?update= {$row['F_ID']}'>{$row['name']}</a></b>";  
        ?>
      </div>
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right" onclick="display_alert()" value="Display alert box" style="background-color: #84654e;"> Update </button>    
      </div>
        </form>
