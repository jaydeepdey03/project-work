...
<html>
  ...
  <head>
    <title> Explore | Food The Yellow Tree Cafe</title>
  </head>
...
?>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li style="color: #fff;"><a href="#" style="color: #fff;">Welcome <?php echo $_SESSION['login_user1']; ?> </a></li>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            <li><a href="#" style="color: #fff;">Welcome <?php echo $_SESSION['login_user2']; ?> </a></li>
            <li class="active" ><a href="foodlist.php" style="color: #fff;">Food Zone </a></li>
            <li><a href="cart.php" style="color: #fff;">Cart  (<?php
              ...
              echo "$count"; 
                ...
                echo "0";
              ?>) </a></li>
            <li><a href="logout_u.php" style="color: #fff;">Log Out </a></li>
          </ul>
  <?php        
}
else {
...
<div class="jumbotron" style="color: #84654e; text-align: center; background: url('https://cdn.hipwallpaper.com/i/97/53/QW3VYy.jpg') no-repeat;">
