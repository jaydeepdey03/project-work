...
?>
        ...
        <div class="jumbotron" style="text-align: center; background: url('https://cdn.hipwallpaper.com/i/97/53/QW3VYy.jpg') no-repeat;">
            <h1 class="text-right" style="color: chocolate; font-size: 40px;"><span class=""></span> Order Placed Successfully.</h1>
          </div>
        </div>
        <br>

<h2 class="text-center"> Thank you for Ordering at The Yellow Tree Cafe! The ordering process is now complete.</h2>
