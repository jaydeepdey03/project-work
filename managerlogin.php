...
<html>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron" style="color: #5a342e; text-align: right; background: url('https://cdn.hipwallpaper.com/i/97/53/QW3VYy.jpg') no-repeat;">
     <h1>Hi Manager,<br></h1>
     <br>
   <p>Kindly LOGIN to continue.</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
       ...
       <label style="margin-left: 5px;"><a href="managersignup.php" style="color: #5a342e;">Create a new account.</a></label>
