...
if(!empty($_SESSION["cart"]))
{
  ?>
  <div class="container">
  <div class="jumbotron" style="color: #84654e; text-align: right; background: url('https://cdn.hipwallpaper.com/i/97/53/QW3VYy.jpg') no-repeat;">
        <h1 style="color: #84654e;">Your Shopping Cart</h1>
        <p style="color: brown;">Looks tasty...!!!</p>
...
<?php
  echo '<a href="cart.php?action=empty"><button class="btn btn-danger"><span class=""></span> Empty Cart</button></a>&nbsp;<a href="foodlist.php"><button class="btn btn-warning">Continue Shopping</button></a>&nbsp;<a href="payment.php"><button class="btn btn-success pull-right"><span class=""></span> Check Out</button></a>';
?>
</div>
...
if(empty($_SESSION["cart"]))
{
  ?>
  <div class="container">
  <div class="jumbotron" style="text-align: center; background: url('https://cdn.hipwallpaper.com/i/97/53/QW3VYy.jpg') no-repeat;">
        <h1 style="color: #631616;">Your Shopping Cart</h1>
        <p style="color: #84654e;">Oops! We can't smell any food here. Go back and <a href="foodlist.php" style="color: red; text-decoration: underline">order now</a></p>
