...
<html>
  ...
  <head>
    <title> Online Payment | The Yellow Tree Cafe </title>
  </head>
...
<div class="container">
    ...
    <div class="jumbotron" style="text-align: center; background: url('https://cdn.hipwallpaper.com/i/97/53/QW3VYy.jpg') no-repeat;">
          <h1 class="text-right" style="color: #754826;">Online Payment</h1>
          <p class="text-right" style="color: #754826;">Enter your payment details below.</p>
        </div>
    </div>
    <div class="row">
